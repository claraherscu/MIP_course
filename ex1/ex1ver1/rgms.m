...
%     new_roi = imdilate(roi,SE);
    new_roi = roi | circshift(roi,[-1 -1 -1]); 
    new_roi = new_roi | circshift(roi,[-1 0 -1]);
    new_roi = new_roi | circshift(roi,[-1 1 -1]);
    new_roi = new_roi | circshift(roi,[0 -1 -1 ]);
    new_roi = new_roi | circshift(roi,[0 0 -1 ]);
    new_roi = new_roi | circshift(roi,[0 1 -1]);
    new_roi = new_roi | circshift(roi,[1 -1 -1]);
    new_roi = new_roi | circshift(roi,[1 0 -1]);
    new_roi = new_roi | circshift(roi,[1 1 -1]);
    
    new_roi = new_roi | circshift(roi,[-1 -1 0]); 
    new_roi = new_roi | circshift(roi,[-1 0 0]);
    new_roi = new_roi | circshift(roi,[-1 1 0]);
    new_roi = new_roi | circshift(roi,[0 -1 0]);
    new_roi = new_roi | circshift(roi,[0 0 0]);
    new_roi = new_roi | circshift(roi,[0 1 0]);
    new_roi = new_roi | circshift(roi,[1 -1 0]);
    new_roi = new_roi | circshift(roi,[1 0 0]);
    new_roi = new_roi | circshift(roi,[1 1 0]);
